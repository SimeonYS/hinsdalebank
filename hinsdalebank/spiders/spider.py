...
from ..items import HhinsdalebankItem
from itemloaders.processors import TakeFirst
import json

pattern = r'(\xa0)?'
base = 'https://www.hinsdalebank.com/content/wintrust/hinsdalebank/en/small-business/resources/financial-education.article.{}.json?limit=10'
class HhinsdalebankSpider(scrapy.Spider):
	name = 'hinsdalebank'
	page = 0
	...
	def parse_post(self, response, date, title):
		...
		item = ItemLoader(item=HhinsdalebankItem(), response=response)
